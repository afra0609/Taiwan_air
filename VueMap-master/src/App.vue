<template lang="pug">
  #app
    ...
    .mapRapper(:style="{width: mapWidthpx, height: mapHeightpx}")
      ...
      Matsu(@closemap="closemap" @getCountryName="showName" v-if="focusContry['連江縣']" :width="mapWidth" :height="mapHeight"  :scale="scaleMap" :zoom="zoom")
